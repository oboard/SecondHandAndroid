...
public class FavoriteActivity extends AppCompatActivity {
    ...
    private List<ResultBeanData.ResultBean> mFavoriteList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new FavoriteAdapter(mFavoriteList);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, jsonBody,
                            ...
                            try {
                                ...
                                if (ret == 0) {
                                    ...
                                    for (int i = 0; i < data.length(); i++) {
                                        ...
                                        mFavoriteList.add(goodsInfo);
                                    }
                                    mAdapter.notifyDataSetChanged();
                                    mTvEmpty.setVisibility(mFavoriteList.isEmpty() ? View.VISIBLE : View.GONE);
                                } else {
                                    String desc = response.getString("desc");
                                    Toast.makeText(FavoriteActivity.this, desc, Toast.LENGTH_SHORT).show();
                                }
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(FavoriteActivity.this, "网络错误", Toast.LENGTH_SHORT).show();
                        }
                    });
