package com.lyhzytlxt.secondhand.message.adapter;
...
import com.lyhzytlxt.secondhand.app.PurchaseActivity;
import com.lyhzytlxt.secondhand.message.bean.MessageListBean;
import com.lyhzytlxt.secondhand.utils.Constants;


public class LinearAdapter extends RecyclerView.Adapter<com.lyhzytlxt.secondhand.message.adapter.LinearAdapter.LinearViewHolder> {
    ...
    @NonNull
    @Override
    public com.lyhzytlxt.secondhand.message.adapter.LinearAdapter.LinearViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
